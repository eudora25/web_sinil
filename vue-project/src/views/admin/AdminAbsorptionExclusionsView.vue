  ...
  <div class="admin-absorption-exclusions page-container">
    ...
    <div class="data-card">
      ...
      >
        ...
        <Column field="pharmacy_business_reg_no" header="약국 사업자번호" :headerStyle="{ width: '16%' }" />
        <Column field="insurance_code" header="보험코드" :headerStyle="{ width: '13%' }" />
        <Column field="product_name" header="품목" :headerStyle="{ width: '21%' }" />
        <Column field="remarks" header="비고" :headerStyle="{ width: '14%' }" />
        <Column header="작업" :headerStyle="{ width: '8%' }">
