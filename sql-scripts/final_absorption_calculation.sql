...
BEGIN
    ...
    FOR result_record IN
        ...
        -- 5. 최종 결과 계산 (standard_code 매칭만 사용)
        SELECT 
            pb.absorption_analysis_id,
            -- 도매 매출 계산 (standard_code 매칭)
            SUM(
    ...
    RAISE NOTICE '흡수율 분석 완료 (최종 수정): %월', p_settlement_month;
END;
$$;
